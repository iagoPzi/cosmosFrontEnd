...
export function UserCEP(props: UserCEPProps){
    return(
        ...
        <Container className="bg-[url('./assets/bgNave.png')] h-[100vh] bg-center flex justify-center items-center text-white text-center relative">
            ...
            <div className="w-[28rem] h-[20rem] backdrop-blur-md bg-[#00000013] absolute top-[7rem] left-[20rem] rounded-lg flex flex-col justify-center items-center p-7 gap-2">
                ...
                <input placeholder="00.000-000" className="p-2 rounded-md text-black" />
                </div>
                <button type="button" 
