      ...
      <div className="h-[100vh] flex flex-col">
        ...
        <div className="h-full flex flex-col justify-center items-center gap-10 md:gap-20 text-center px-7">
          <div className="flex flex-col gap-3">
            <h2 className="font-bold text-2xl">Enviamos o link novamente</h2>

            <p className="text-lg">
            Verifique sua conta pelo link que enviamos para o<br />e-mail [email@email.com] e depois faça seu login
            </p>
          </div>
